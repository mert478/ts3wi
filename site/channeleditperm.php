...
if (isset($_POST['editall']))
	...
	foreach($allpermsedit AS $key => $value)
		...
		$ts3->channelDeletePerm($cid, $delperms);

	}	


$channellist=$ts3->channelPermList($cid);
...
<table  class="border" cellpadding="0" cellspacing="0" style="width:100%">
	<tr>
		...
		<form method="post" action="index.php?site=channeleditperm&amp;cid=<?php echo $cid; ?>&amp;port=<?php echo $port; ?>">
	...
	<tr>
		<td class="thead" colspan="6"><?php echo "(".$cid.")".$channelname.$lang['permissionlist'];?></td>
	</tr>
	<tr>
	...
	foreach($allperms AS $value)
		...
		?>
		<tr>
		<form method="POST" action="index.php?site=channeleditperm&amp;port=<?php echo $port; ?>&amp;cid=<?php echo $cid; ?>" name="<?php echo $value['permid']; ?>">
